...
app.post('/api/register', async (req, res) => {
  ...
  // Additional email validation: check for university domain (optional)
  const universityDomains = ['.edu', '.ac.uk', '.edu.au', 'university.edu']; // Add your university domains
  const hasValidDomain = universityDomains.some(domain => email.toLowerCase().endsWith(domain));
  if (!hasValidDomain) {
